...
resource "aws_iam_role" "cluster" {
  ...
  tags = { Name = "${var.app_name}-eks-cluster" }
}
...
resource "aws_iam_role" "node" {
  ...
  tags = { Name = "${var.app_name}-eks-node" }
}
...
# Managed Node Group (t3.small for cost saving)
resource "aws_eks_node_group" "main" {
  ...
  tags = { Name = "${var.app_name}-nodes" }
}

# OIDC Provider for IRSA (needed for AWS Load Balancer Controller, etc.)
